...
qantasApp.factory 'phoneValidation', ($http, $q, $rootScope, auth, prefs) ->

    factory = {}

    #Selected country object stores iso when country is selected
    ...
    factory.formatPhoneNumber = (number) ->
        if prefs.countryISO?
            formatE164 prefs.countryISO, number
        else
    ...
    factory.setup = ->
        if prefs.countryISO?
            ...
            factory.selectedCountry.phoneNumber = factory.getExampleNumber('us')
